...
::: {.column width="60%"}
![](images/arrow-hex.png){fig-align="right" width="300"}
:::
:::
...
See more detail on this example at:
...
1.  Load everything via something fast (vroom): NA - fell over as ran out of memory
2.  Batching via vroom - 141672ms
3.  Raw log files (arrow) - 1154ms
4.  Parquet files (arrow) - 433ms
...
- Doing data engineering up front saves time later (and overcomes limitations of CSVs)
